...
//* DEFAULT
//* *****************************************************************************
gulp.task('build', gulp.series(gulp.parallel('clean-tsc', 'lint'), gulp.parallel('build-src', 'build-test')))
gulp.task('test', gulp.series('clean-tsc', gulp.parallel('build-src', 'build-test'), 'mocha', 'remap-istanbul'))
gulp.task('testjs', gulp.series(testjs, 'clean-tsc', gulp.parallel('build-src'), 'mocha', 'remap-istanbul'))
...
const watch = function () {
  wrap(gulp.watch(paths.ts.concat(paths.testjs), gulp.series('testjs')), 'watch')
}
